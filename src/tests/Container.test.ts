...
describe("Dependency Injection Container Tests", () => {
    describe("Properties tests", () => {
        ...
        it("Should register multiple properties with multiple calls", () => {
            ...
            expect(Object.keys(container.getProperties()).length).toBe(
                testProps.length
            );
        });
    ...
    describe("Services tests", () => {
        it("Should register a valid service injecting raw values", () => {
            ...
            expect(container.getServices()["test-service1"].instance).toBeInstanceOf(
                TestService3
            );
        ...
        it("Should register a service depending on some properties already registered properties", () => {
            ...
            expect(
                (container.getService("test-service1") as TestService1).getArg1()
            ).toBe(testProps.prop1);
        });
        ...
        it("Should register a LAZY service depending on some not yet registered properties", () => {
            ...
            expect(container.getService("test-service1")).toBeInstanceOf(
                TestService1
            );
            expect(
                (container.getService("test-service1") as TestService1).getArg1()
        ...
        it("Should register a service depending on other properties & services", () => {
            ...
            expect(
                (container.getService("test-service2") as TestService2).getArg2()
            ).toBe(testProps.prop2);
            expect(
                (container.getService("test-service2") as TestService2).getArg3()
            ).toBeInstanceOf(TestService1);
            expect(
                (container.getService("test-service2") as TestService2)
                    .getArg3()
                    .getArg1()
            ).toBe(testProps.prop1);
        });
        ...
        it("Should register a LAZY service depending on other properties & LAZY services", () => {
            ...
            // expect service to be instanciated
            expect(container.getServices()["test-service2"].instance).toBeInstanceOf(
                TestService2
            );
